 ...
 * @author kim19
 */
public class SpecialEffectGrass extends GameObject {
    ...
    public SpecialEffectGrass(String[] path, int x, int y, int[] info) {
        super(x, y, info[0], info[1], info[2]);
        try {
            img1 = ImageIO.read(getClass().getResource(path[4]));
            img2 = ImageIO.read(getClass().getResource(path[5]));
        } catch (IOException e) {
            e.printStackTrace();
        }
